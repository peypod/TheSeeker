...
pub struct PickupAssetHandles {
    map: HashMap<Passive, Handle<Image>>
}
    ...
    fn apply(self, world: &mut World) {
        ...
        match self.p_type.clone() {
            ...
            PickupType::PassiveDrop(passive) => {
                ...
                let texture_handle = handles.map.get(&passive).unwrap();
...
impl DropTracker {
    ...
    fn reset(passive_count: usize) -> Self {
        ...
        for i in 0..passive_count {
            rolls.push(SPAN * i as u32 + rng.gen_range(0..SPAN));
        }
